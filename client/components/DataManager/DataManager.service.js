...
angular.module('steamAppApp')
  .factory('DataManager', function ($http, $q, Formatters) {
    ...
    var _query = function (queryParams, callback) {
    ...
    var setSeriesColors = function (card, series) {
     ...
     * @param options
     */
    var applySeriesOptions = function (series, options) {
    ...
    function geoMapDataTransformer(data, options) {
      var generateGeoJSONData = function (geoRecs) {
        var returnGeoJSON = [];
...
//                }
    ...
    DataManager.chartPaging = {
      getPagingValuesFromClause: function(pagingClause) {
        var pagingValues = {};
      ...
      getRecTotal: function(card, callback) {
        var templateVariables = card.options.getTemplateVariables();
        // Set paging totals
      ...
      //   var templateVariables = card.options.getTemplateVariables();
      //   var pagingClauseValues = this.getPagingValuesFromClause(templateVariables.cardFilter_pagingClause);
      //   var newOffset = pagingClauseValues.offset - pagingClauseValues.limit;
      //   // Prevent passing lower bound
      //   if(newOffset >= 0) {
      //     templateVariables.cardFilter_pagingClause = "LIMIT " + pagingClauseValues.limit + " OFFSET " + newOffset;
      //     FilterService.createFilteredQuery(card, templateVariables);
      //   }
      // },
      //
      ...
      //   var pagingClauseValues = this.getPagingValuesFromClause(templateVariables.cardFilter_pagingClause);
      //   var newOffset = pagingClauseValues.offset + pagingClauseValues.limit;
      //   // Prevent passing upper bound
      //   if(newOffset < templateVariables.cardFilter_pagingRecTotal) {
      //     templateVariables.cardFilter_pagingClause = "LIMIT " + pagingClauseValues.limit + " OFFSET " + newOffset;
      //     FilterService.createFilteredQuery(card, templateVariables);
      //   }
      // },
      ...
      //   var templateVariables = card.options.getTemplateVariables();
      //   var pagingClauseValues = this.getPagingValuesFromClause(templateVariables.cardFilter_pagingClause);
      //   // Prevent reloading if lower bound
      //   if(pagingClauseValues.offset > 0) {
      //     templateVariables.cardFilter_pagingClause = "LIMIT " + pagingClauseValues.limit + " OFFSET 0";
      //     FilterService.createFilteredQuery(card, templateVariables);
      //   }
      // },
      //
      ...
      //   // There has got to be a more simple way to do this ...
      //   var maxOffset = Math.ceil(templateVariables.cardFilter_pagingRecTotal / pagingClauseValues.limit) * pagingClauseValues.limit - pagingClauseValues.limit;
      //   // Prevent reloading if upper bound
      //   if(pagingClauseValues.offset < maxOffset) {
      //     templateVariables.cardFilter_pagingClause = "LIMIT " + pagingClauseValues.limit + " OFFSET " + maxOffset;
      //     FilterService.createFilteredQuery(card, templateVariables);
      //   }
      // }
    };
