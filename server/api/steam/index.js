...
router.get('/friendGamesTable', auth.isAuthenticated(), controller.friendGamesTable);
router.get('/friendsGamesChart', auth.isAuthenticated(), controller.friendsGamesChart);
